  ...
  return (
    <div className="flex items-center gap-2 rounded-md border border-civic-line bg-civic-panel p-1 shadow-panel">
      ...
      <select
        ...
        disabled={disabled}
        className="h-8 rounded border-0 bg-civic-panel px-1 text-sm font-medium text-civic-ink outline-none disabled:cursor-not-allowed disabled:text-civic-muted disabled:opacity-50"
